...
public class QuestionModel {
	...
	@NotEmpty(message = "correctAnswer space cant be empty")
	private String correctAnswer;
	@NotEmpty(message = "DifficultyLevel space cant be empty")
	private String questionDifficultyLevel;
	@NotEmpty(message = "QuestionCateogry space cant be empty")
	private String questionCateogry;
